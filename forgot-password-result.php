...
function send_to($email)
{
	...
	if($result -> num_rows > 0) 
	{
		...
		if ($conn->query($sql) === TRUE) 
		{
			...
			$msg = wordwrap($msg,70) ;
			$worked = mail($email,"TasteHub: Reset Password",$msg,"From: localhost:81/127.0.0.1");
		...
		<div class="full-body">
			...
			<div class="content">
				<table class="content-table">
					<tr>
						<td class="content-table-left"><h1 class="content-table-left-header">TasteHub</h1></td>
